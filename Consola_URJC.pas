...
{Objetivo del programa: Crear una consola que trabaje con usuarios y contraseñas, los cuales se guardan permanentemente en
un fichero de usuarios. Ademas de crear un juego ('URJC INVADERS') que genera unas estadisticas del jugador. Estas estadisticas
se guardan en un archivo de texto con el formato ('usuario + año + mes + dia + .txt')}
